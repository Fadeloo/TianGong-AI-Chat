...
try:
    ...
    with st.sidebar:
        ...
        st.subheader(
            "您的智能助手",
            help="Intelligent Audit Assistant",
        )
        ...
        with st.expander(ui.sidebar_expander_title, expanded=True):
            ...
            if search_internal:
                search_internal_collection = weaviate_connection("audit") #需修改weaviate collection的名称
        ...
        if "xata_history_refresh" not in st.session_state:
            ...
            if user_query:
                ...
                if answer is not None:
                    ...
                    if search_sci or search_internal:
                        ...
                        if search_internal:
                            internal_response = weaviate_hybrid_search_extention(
                                search_internal_collection, query, top_k=8, ext_k=0
                            )
                            docs_response.append(internal_response)
